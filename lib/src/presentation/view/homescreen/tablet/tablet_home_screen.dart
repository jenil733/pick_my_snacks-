...
class _TabletHomeScreenState extends State<TabletHomeScreen> {
  ...
  final _searchFocusNode = FocusNode(debugLabel: 'tablet-product-search');
  final _staffMenuController = StaffMenuButtonController();
  ...
  void _focusSearch() {
    ...
    final textLength = widget.controller.searchController.text.length;
    widget.controller.searchController.selection = TextSelection(
      baseOffset: 0,
  ...
  void _printReceipt() {
    ...
    setState(() => _selectedDetail = 1);
    printReceipt(context, widget.controller);
  }

  void _openStaffMenu() {
    _staffMenuController.open();
  }
  ...
  Widget build(BuildContext context) {
    return CallbackShortcuts(
      bindings: {
        ...
        const SingleActivator(LogicalKeyboardKey.f2): _printReceipt,
        const SingleActivator(LogicalKeyboardKey.f3): _openStaffMenu,
      },
      child: Focus(
        autofocus: true,
        child: PopScope<Object?>(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                StaffMenu(buttonController: _staffMenuController),
